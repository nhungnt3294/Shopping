<%-- 
    Document   : signin
    Created on : Oct 8, 2019, 11:20:09 PM
    Author     : HP
--%>
            ...
            <div class="container">
                <div class="signin-content">
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" class="register-form" id="login-form" action= "<%= request.getContextPath() %>/Signin_Servlet">
							<%
							String mss = "";
							if(request.getAttribute("err") != null) {
								mss = (String) request.getAttribute("err");
							%>
